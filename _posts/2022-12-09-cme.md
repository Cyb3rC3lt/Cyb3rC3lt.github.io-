...
crackmapexec ldap $DCIP -u Username -p Password -M GROUP-MEM -o GROUP="domain admins"
{% endhighlight %}

**GROUP-MEM Module:  Returning Domain Controllers**

{% highlight powershell %}
crackmapexec ldap $DCIP -u Username -p Password -M GROUP-MEM -o GROUP="domain controllers"
{% endhighlight %}
